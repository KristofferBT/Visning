...
try {
    Echo "SQL Insert";
    $sql = "Insert into CustomerRoomCheckListMedia (MediaFile, MediaCustomerRoomCheckListID, MediaCustomerRoomID, MediaCustomerPropertyID, MediaCreatedDate) Values ("
            . " :MediaFile,"
            . " :CheckListID,"
            . " :CustRoomID,"
            . " :CustPropertyID,"
    ...
    $stmt->BindValue(':MediaFile', $blob_name, PDO::PARAM_STR);
    $stmt->BindValue(':CheckListID', $_POST['CheckListID'], PDO::PARAM_INT);
    $stmt->BindValue(':CustRoomID', $_POST['RoomID'], PDO::PARAM_INT);
    $stmt->BindValue(':CustPropertyID', $_POST['PropertyID'], PDO::PARAM_INT);
    $stmt->Execute();
    echo $sql;
