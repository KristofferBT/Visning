...
//Henter ut RoomID fra data-href attr. Trigges av onclick pÃ¥ <a>.
...
$(document).ready(function() {
 ...
 $('[id^=RoomEdit]').click(function(event){

//    $('#RoomDescription').editable({
//        url: '/inc/RoomUpdateRoom.php'
//    });
    
    
    
    //$(this).closest('panel-body').children('#RoomDescription').editable();
...
//End - Ã…pner opp nytt rom dialog
